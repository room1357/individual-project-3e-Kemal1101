...
class AuthLogic {
  ...
  Future<void> _fetchUsers() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.100.138/expenseapp/get_users.php'));
  ...
  Future<bool> register(String fullName, String username, String email, String password) async {
    ...
    try {
      final uri = Uri.parse('http://192.168.100.138/expenseapp/register_users.php');
